...
public class FilmService {
    ...
    public FilmService() {
        ...
        Film aNewHope = new Film(
                "A New Hope", 4, "George Lucas", LocalDate.of(1977, Month.JANUARY, 25));

        Film theEmpireStrikesBack = new Film(
                "The Empire Strikes Back", 5, "Irvin Kershner", LocalDate.of(1980, Month.MARCH, 17));

        Film returnOfTheJedi = new Film(
                "Return of the Jedi", 6, "Richard Marquand", LocalDate.of(1983, Month.MAY, 25));
